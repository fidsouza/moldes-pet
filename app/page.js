...
const gallery = [
  ["/imagens/cachorro-roupa.jpg", "Cachorro com roupinha de tricô"],
  ["/imagens/peca-pronta.jpg", "Roupinha de pet pronta com acabamento profissional"],
  ["/imagens/gato-vestido.jpg", "Gato vestindo uma roupinha de tricô"],
  ["/imagens/processo-costura.jpg", "Costureira costurando uma roupinha de pet"],
];
  ...
  return (
    <>
      ...
      <div className={`sticky${showSticky ? " show" : ""}`}>
        <div className="wrap">
          <div className="l"><b>Pet Ateliê</b><small>100 moldes + 7 bônus + garantia de 7 dias</small></div>
